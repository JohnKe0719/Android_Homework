...
public class WaterReminderFirebaseJobService extends JobService {
    /*
            注意：這是第3個用到的class，接下來用到ReminderTasks.class
       */
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        Log.e("進來了","第3個class：WaterReminderFirebaseJobService");//設置Log，方便在debug模式顯示
        ...
        mBackgroundTask = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] params) {
                ...
                ReminderTasks.executeTask(context, ReminderTasks.ACTION_CHARGING_REMINDER);//從這裡指向ReminderTasks.class
                return null;
            }
